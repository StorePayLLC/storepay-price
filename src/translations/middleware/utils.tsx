...
export function getInternalTemplate<
  ...
  Pathnames extends NonNullable<MiddlewareConfigWithDefaults<Locales>['pathnames']>,
>(pathnames: Pathnames, pathname: string): [Locales[number] | undefined, keyof Pathnames | undefined] {
 ...
 */
export function getNormalizedPathname<Locales extends AllLocales>(pathname: string, locales: Locales) {
...
export function getPathWithSearch(pathname: string, search: string | undefined) {
...
export function isLocaleSupportedOnDomain<Locales extends AllLocales>(locale: string, domain: DomainConfig<Locales>) {
