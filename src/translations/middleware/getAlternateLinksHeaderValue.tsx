...
import { formatTemplatePathname, getHost, getNormalizedPathname, isLocaleSupportedOnDomain } from './utils';
 ...
 */
export default function getAlternateLinksHeaderValue<Locales extends AllLocales>({
  config,
  localizedPathnames,
  request,
  resolvedLocale,
  ...
  normalizedUrl.pathname = getNormalizedPathname(normalizedUrl.pathname, config.locales);
